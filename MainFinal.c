...
void exportarCanciones (ListaCancion listaGlobal) {
    if (listaGlobal.cant == 0){
        printf("No hay datos por guardar, volviendo al menu principal...\n");
        system("pause");
        return;
    }
...
void mostrarNombresListas (List * listasMusica, int size) {
    if (size == 0){
        printf("No se encontraron canciones :( \n");
        system("pause");
        return;
...
void mostrarListaRep (List * listasMusica, int size) {
    if (size == 0){
        printf("No se encontraron canciones :( \n");
        system("pause");
        return;
    ...
    while (op != 9){
        ...
        switch (op) {
            ...
            case 5:
                ...
                break;
            case 6:
                mostrarNombresListas(listasMusica,listaGlobal.cant);
                break;
            case 7:
                mostrarListaRep(listasMusica,listaGlobal.cant);
                break;
            case 8:
